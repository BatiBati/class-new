...
import { AdminPageLogo } from "@/app/(admin)/AdminPage/_components/assets/Logo";
import { FoodMenu } from "./_components/assets/FoodMenu";
import { Van } from "./_components/assets/Van";
import { Settings } from "./_components/assets/Settings";
...
export default function AdminPage() {
  return (
    <div className="w-screen h-screen flex">
      ...
      <div className="h-full w-full bg-[#d9d9d9] p-4">
        <Order />
      </div>
    </div>
  );
